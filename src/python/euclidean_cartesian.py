...
def generate_karate_embedding():
    ...
    path = '../../local_resources/karate/embeddings/euclidean_cartesian_Win' + '_' + utils.get_timestamp() + '.csv'
    ...
    df_out.to_csv(
        '../../local_resources/karete/embeddings/euclidean_cartesian_Wout' + '_' + utils.get_timestamp() + '.csv',
        sep=',')
    return path
